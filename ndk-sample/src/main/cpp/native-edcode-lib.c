...
jbyteArray Java_com_example_ndk_sample_SampleJni_getKeyValue(JNIEnv *env, jobject obj)
{
...
jbyteArray Java_com_example_ndk_sample_SampleJni_getIv(JNIEnv *env, jobject obj)
{
